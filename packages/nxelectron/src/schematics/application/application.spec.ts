...
describe('app', () => {
  ...
  describe('not nested', () => {
            ...
            configurations: {
              production: {
                ...
                fileReplacements: [
                  {
                    replace:
                      'apps/my-electron-app/src/environments/environment.ts',
                    with:
    ...
    it('should generate files', async () => {
      ...
      const tsconfig = readJsonInTree(
        tree,
        'apps/my-electron-app/tsconfig.json'
      );
      ...
      const tslintJson = JSON.parse(
        stripJsonComments(
          getFileContent(tree, 'apps/my-electron-app/tslint.json')
        )
      );
  ...
  describe('nested', () => {
    it('should update workspace.json', async () => {
      ...
      expect(
        workspaceJson.projects['my-dir-my-electron-app-e2e']
      ).toBeUndefined();
  ...
  describe('--unit-test-runner none', () => {
    it('should not generate test configuration', async () => {
      ...
      expect(
        tree.exists('apps/my-electron-app/tsconfig.spec.json')
      ).toBeFalsy();
      ...
      expect(
        workspaceJson.projects['my-electron-app'].architect.lint.options
          .tsConfig
